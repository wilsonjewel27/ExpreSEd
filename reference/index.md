...
- [`example_se`](https://github.com/wilsonjewel27/ExpreSEd/reference/example_se.md)
...
- [`filter_low_exp_genes()`](https://github.com/wilsonjewel27/ExpreSEd/reference/filter_low_exp_genes.md)
...
- [`run_DESeq2()`](https://github.com/wilsonjewel27/ExpreSEd/reference/run_DESeq2.md)
...
- [`log2_shrinkage()`](https://github.com/wilsonjewel27/ExpreSEd/reference/log2_shrinkage.md)
...
- [`generate_volcano()`](https://github.com/wilsonjewel27/ExpreSEd/reference/generate_volcano.md)
...
- [`export_outputs()`](https://github.com/wilsonjewel27/ExpreSEd/reference/export_outputs.md)
