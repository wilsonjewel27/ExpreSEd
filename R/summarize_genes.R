...
#' Summarize the number of significant, upregulated, and 
#' downregulated genes at given thresholds
#'
...
#' )
#'
gene_regulation_summary <- function(res_df, 
                                    p_threshold = 0.05, 
                                    fc_threshold = 0.5) {
...
# Summarize gene counts by regulation direction
